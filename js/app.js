$(".menu__trigger").click(function(e){
   e.stopPropagation();
	$(".menu__navigation").toggleClass("showMenu");
	$(".hamburger-menu .bar").toggleClass("animate");
	if ($(".menu__navigation").hasClass("showMenu")) {
		$(".menu__trigger span").replaceWith("<span>Cerrar</span>");
	} else {
		$(".menu__trigger span").replaceWith("<span>Menú</span>");
	}
});
  
function closeMenu(e){
	$(".menu__navigation").removeClass("showMenu");
...
$(".menu__navigation").click( function(e) {
    e.stopPropagation();
});
